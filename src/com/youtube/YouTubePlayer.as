...
package com.youtube
{
	...
	public class YouTubePlayer extends UIComponent
	{
		...
		[Bindable]
		public var qualityLevels:Array=["default", "small", "medium", "large", "hd720"];
		[Bindable]
		public var videoStates:Array=["unstarted", "ended", "playing", "paused", "buffering", "video cued"];
		...
		private function onLoaderInit(event:Event):void
		{
			...
			this.addEventListener("UPDATE_VIDEO", updateVideo);
		...
		private function updateVideo(event:Event):void
		{
			trace("video updated");
		...
		private function onPlayerStateChange(event:Event):void
		{
			...
			switch (stateIndex)
			{
				case 0:
					...
					break;
				case 1:
					updateInterval=setInterval(function():void
						{
